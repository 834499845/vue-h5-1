  ...
  <div>
    <div class="MedDatedatetimePicker" v-show="dataTrue">
      <div @click="cancelClick"></div>
        <div>
          <mt-datetime-picker placeholder="结束时间" @cancel="cancelClick" :endDate="endDateStr"  @confirm="confirmClick" year-format="{value} 年" month-format="{value} 月" date-format="{value} 日"
