...
export default {
        ...
        if (self.objLists.length > 0) {       
          messgaeObj = {
            ...
            params: {
              ...
              // deptName: self.objLists[0].deptName // 部门名称
  ...
  methods: {
    ...
    // 日常-签到统计
    normalSignSearchListFun() {
      var self = this;
      var timeValue = "";
      var obj = {};
      if (self.objLists.length > 1) {
        var inputBumenIds = [];
      ...
      self
        .getSignApiSignDetailOutSignCount(object)
        .then(data => {
    ...
    ...mapActions([
      "getdangSend",
      "getSignApiSignDetailOutSignCount",
      "getSignApiSignGetSetting"
    ])
  },
  created: function() {
    ...
    if (isAndroid) {
      ...
      var setNav = {
        ...
        params: {
          naviType: 0,
          titles: [{ name: "我的", code: "my", notEnable: 0 }]
        },
